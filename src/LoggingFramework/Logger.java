...
import LoggingFramework.strategies.appender.NetworkAppender;
...
public class Logger {
    ...
    public void log(LogLevel messageLevel, String message) {
        if (messageLevel.isAsSevereAs(getEffectiveLevel())) {
            LogMessage logMessage = new LogMessage(messageLevel, message);
